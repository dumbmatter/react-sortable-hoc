!(function(e, t) {
  ...
  function $(n) {
    ...
    return (
      (t = e = (function(e) {
        function t() {
          return u(this, t), y(this, g(t).apply(this, arguments));
        }
        return (
          m(t, e),
          f(t, [
  ...
  var Z = {
    ...
    ee = {lift: [U], drop: [U], cancel: [X], up: [q, Y], down: [V, F]},
    te = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
    ...
    return (
      (n = e = (function(e) {
        function n(e) {
          ...
          return (
            u(this, n),
            (I = y(this, g(n).call(this, e))),
            c(p(p(I)), 'state', {}),
            c(p(p(I)), 'handleStart', function(e) {
              var t = I.props,
                n = t.distance,
                o = t.shouldCancelStart;
              if (2 !== e.button && !o(e)) {
                (I.touched = !0), (I.position = K(e));
                var r,
                ...
                if (
                  ...
                  var a = I.props.useDragHandle,
                    s = i.sortableInfo,
                    l = s.index,
                    c = s.collection;
                  if (s.disabled) return;
                  if (a && !W(e.target, J)) return;
                  (I.manager.active = {collection: c, index: l}),
                    ((r = e).touches && r.touches.length) ||
                      (r.changedTouches && r.changedTouches.length) ||
                      e.target.tagName !== z.Anchor ||
                      e.preventDefault(),
                    n ||
                      (0 === I.props.pressDelay
                        ? I.handlePress(e)
                        : (I.pressTimer = setTimeout(function() {
                            return I.handlePress(e);
                          }, I.props.pressDelay)));
                }
              }
            }),
            c(p(p(I)), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === I.manager;
            }),
            c(p(p(I)), 'handleMove', function(e) {
              var t = I.props,
                n = t.distance,
                o = t.pressThreshold;
              if (
                !I.state.sorting &&
                I.touched &&
                !I._awaitingUpdateBeforeSortStart
              ) {
                var r = K(e),
                  i = {x: I.position.x - r.x, y: I.position.y - r.y},
                  a = Math.abs(i.x) + Math.abs(i.y);
                (I.delta = i),
                  n || (o && !(o <= a))
                    ? n && n <= a && I.manager.isActive() && I.handlePress(e)
                    : (clearTimeout(I.cancelTimer),
                      (I.cancelTimer = setTimeout(I.cancel, 0)));
              }
            }),
            c(p(p(I)), 'handleEnd', function() {
              (I.touched = !1), I.cancel();
            }),
            c(p(p(I)), 'cancel', function() {
              var e = I.props.distance;
              I.state.sorting ||
                (e || clearTimeout(I.pressTimer), (I.manager.active = null));
            }),
            c(p(p(I)), 'handlePress', function(k) {
              try {
                var r = I.manager.getActive(),
                  e = (function() {
                    if (r) {
                      var e = function() {
                          var e,
                            t,
                            n = O.sortableInfo.index,
                            o =
                              ((e = O),
                              {
                                bottom: P(
                            ...
                            r = I.scrollContainer.getBoundingClientRect(),
                            i = m({collection: T, index: n, node: O});
                          (I.node = O),
                            (I.margin = o),
                            (I.width = i.width),
                            (I.height = i.height),
                            (I.marginOffset = {
                              x: I.margin.left + I.margin.right,
                              y: Math.max(I.margin.top, I.margin.bottom),
                            }),
                            (I.boundingClientRect = O.getBoundingClientRect()),
                            (I.containerBoundingRect = r),
                            (I.index = n),
                            (I.newIndex = n),
                            (I.axis = {
                              x: 0 <= v.indexOf('x'),
                            ...
                            (I.offsetEdge = _(O, I.container)),
                            (I.initialOffset = K(
                              C
                                ? E({}, k, {
                                    pageX: I.boundingClientRect.left,
                                    pageY: I.boundingClientRect.top,
                                  })
                                : k,
                            )),
                            (I.initialScroll = {
                              left: I.scrollContainer.scrollLeft,
                              top: I.scrollContainer.scrollTop,
                            }),
                            (I.initialWindowScroll = {
                          ...
                          var a,
                            ...
                            u =
                              ...
                              (l = (a = O).querySelectorAll(s)),
                              (c = a.cloneNode(!0)),
                              R(c.querySelectorAll(s)).forEach(function(e, t) {
                                'file' !== e.type && (e.value = l[t].value),
                                  'radio' === e.type &&
                                    e.name &&
                                  ...
                                  e.tagName === z.Canvas &&
                                    0 < l[t].width &&
                                    0 < l[t].height &&
                                    e.getContext('2d').drawImage(l[t], 0, 0);
                              }),
                              c);
                          if (
                            ((I.helper = I.helperContainer.appendChild(u)),
                            N(I.helper, {
                              boxSizing: 'border-box',
                              height: ''.concat(I.height, 'px'),
                              left: ''.concat(
                                I.boundingClientRect.left - o.left,
                                'px',
                              ),
                              pointerEvents: 'none',
                              position: 'fixed',
                              top: ''.concat(
                                I.boundingClientRect.top - o.top,
                                'px',
                              ),
                            ...
                            var d = S
                                ? {
                                    top: 0,
                                    left: 0,
                                    width: I.contentWindow.innerWidth,
                                    height: I.contentWindow.innerHeight,
                                  }
                                : I.containerBoundingRect,
                              f = d.top,
                              h = d.left,
                              p = d.width,
                              y = f + d.height,
                            ...
                            I.axis.x &&
                              ((I.minTranslate.x =
                                h - I.boundingClientRect.left),
                              (I.maxTranslate.x =
                                g - (I.boundingClientRect.left + I.width))),
                              I.axis.y &&
                                ((I.minTranslate.y =
                                  f - I.boundingClientRect.top),
                                (I.maxTranslate.y =
                                  y - (I.boundingClientRect.top + I.height)));
                          } else
                            I.axis.x &&
                              ((I.minTranslate.x =
                                (S ? 0 : r.left) -
                                I.boundingClientRect.left -
                                I.width / 2),
                              (I.maxTranslate.x =
                                (S
                                  ? I.contentWindow.innerWidth
                                  : r.left + r.width) -
                                I.boundingClientRect.left -
                                I.width / 2)),
                              I.axis.y &&
                                ((I.minTranslate.y =
                                  (S ? 0 : r.top) -
                                  I.boundingClientRect.top -
                                  I.height / 2),
                                (I.maxTranslate.y =
                                  (S
                                    ? I.contentWindow.innerHeight
                                    : r.top + r.height) -
                                  I.boundingClientRect.top -
                                  I.height / 2));
                          x &&
                            x.split(' ').forEach(function(e) {
                              return I.helper.classList.add(e);
                            }),
                            (I.listenerNode = k.touches ? O : I.contentWindow),
                            C
                              ? (I.listenerNode.addEventListener(
                                  'wheel',
                                  I.handleKeyEnd,
                                  !0,
                                ),
                            ...
                            I.setState({sorting: !0, sortingIndex: n}),
                            w &&
                              w(
                                {
                                  clonedNode: u,
                        ...
                        t = I.props,
                        v = t.axis,
                        m = t.getHelperDimensions,
                        x = t.helperClass,
                        b = t.hideSortableGhost,
                        n = t.updateBeforeSortStart,
                        w = t.onSortStart,
                        S = t.useWindowAsScrollContainer,
                        O = r.node,
                        T = r.collection,
                        C = I.manager.isKeySorting,
                        o = (function() {
                          if ('function' == typeof n) {
                            I._awaitingUpdateBeforeSortStart = !0;
                            var e = (function(e, t) {
                              try {
                                var n = e();
                              } catch (e) {
                              ...
                              function(e, t) {
                                if (
                                  ((I._awaitingUpdateBeforeSortStart = !1), e)
                                )
                                  throw t;
                                return t;
                              },
            ...
            c(p(p(I)), 'handleSortMove', function(e) {
              var t = I.props.onSortMove;
              'function' == typeof e.preventDefault && e.preventDefault(),
                I.updateHelperPosition(e),
                I.animateNodes(),
                I.autoscroll(),
                t && t(e);
            }),
            c(p(p(I)), 'handleSortEnd', function(e) {
              var t = I.props,
              ...
              I.listenerNode &&
                (a
                  ? (I.listenerNode.removeEventListener(
                      'wheel',
                      I.handleKeyEnd,
                      !0,
                    ),
                  ...
                  : (D.move.forEach(function(e) {
                      return I.listenerNode.removeEventListener(
                        e,
                        I.handleSortMove,
                      );
                    }),
                ...
                I.helper.parentNode.removeChild(I.helper),
                n &&
                  I.sortableGhost &&
                  N(I.sortableGhost, {opacity: '', visibility: ''});
              for (var l = 0, c = s.length; l < c; l++) {
                var u = s[l],
                  d = u.node;
                (u.edgeOffset = null),
                  A(d, (u.boundingClientRect = null)),
                  M(d, null),
                  (u.translate = null);
              }
              I.autoScroller.clear(),
                (I.manager.active = null),
                (I.manager.isKeySorting = !1),
                I.setState({sorting: !1, sortingIndex: null}),
                'function' == typeof o &&
                  o(
                    {
                      collection: i,
            ...
            c(p(p(I)), 'autoscroll', function() {
              var e = I.props.disableAutoscroll,
                t = I.manager.isKeySorting;
              if (e) I.autoScroller.clear();
              else {
                if (t) {
                  var n = E({}, I.translate),
                    o = 0,
                  ...
                  return (
                    I.axis.x &&
                      ((n.x = Math.min(
                        I.maxTranslate.x,
                        Math.max(I.minTranslate.x, I.translate.x),
                      )),
                      (o = I.translate.x - n.x)),
                    I.axis.y &&
                      ((n.y = Math.min(
                        I.maxTranslate.y,
                        Math.max(I.minTranslate.y, I.translate.y),
                      )),
                      (r = I.translate.y - n.y)),
                    (I.translate = n),
                    A(I.helper, I.translate),
                    (I.scrollContainer.scrollLeft += o),
                    void (I.scrollContainer.scrollTop += r)
                  );
                }
                I.autoScroller.update({
                  height: I.height,
                  maxTranslate: I.maxTranslate,
                  minTranslate: I.minTranslate,
                  translate: I.translate,
                  width: I.width,
                });
              }
            }),
            c(p(p(I)), 'onAutoScroll', function(e) {
              (I.translate.x += e.left),
                (I.translate.y += e.top),
                I.animateNodes();
            }),
            c(p(p(I)), 'handleKeyDown', function(e) {
              var t = e.keyCode,
                n = I.props,
                o = n.shouldCancelStart,
                r = n.keyCodes,
                i = E({}, ee, void 0 === r ? {} : r);
              (I.manager.active && !I.manager.isKeySorting) ||
                !(
                  I.manager.active ||
                  (i.lift.includes(t) && !o(e) && I.isValidSortingTarget(e))
                ) ||
                (e.stopPropagation(),
                e.preventDefault(),
                i.lift.includes(t) && !I.manager.active
                  ? I.keyLift(e)
                  : i.drop.includes(t) && I.manager.active
                  ? I.keyDrop(e)
                  : i.cancel.includes(t)
                  ? ((I.newIndex = I.manager.active.index), I.keyDrop(e))
                  : i.up.includes(t)
                  ? I.keyMove(-1)
                  : i.down.includes(t) && I.keyMove(1));
            }),
            c(p(p(I)), 'keyLift', function(e) {
              var t = e.target,
                n = W(t, function(e) {
                  return null != e.sortableInfo;
                }).sortableInfo,
                o = n.index,
                r = n.collection;
              (I.initialFocusedNode = t),
                (I.manager.isKeySorting = !0),
                (I.manager.active = {index: o, collection: r}),
                I.handlePress(e);
            }),
            c(p(p(I)), 'keyMove', function(e) {
              var t = I.manager.getOrderedRefs(),
                n = t[t.length - 1].node.sortableInfo.index,
                o = I.newIndex + e,
                r = I.newIndex;
              if (!(o < 0 || n < o)) {
                (I.prevIndex = r), (I.newIndex = o);
                var i,
                  a,
                  s,
                  l =
                  ...
                  u = c.node,
                  d = I.containerScrollDelta,
                  f = c.boundingClientRect || H(u, d),
                  h = c.translate || {x: 0, y: 0},
                  p = f.top + h.y - d.top,
                  y = f.left + h.x - d.left,
                  g = r < o,
                  v = g && I.axis.x ? u.offsetWidth - I.width : 0,
                  m = g && I.axis.y ? u.offsetHeight - I.height : 0;
                I.handleSortMove({
                  pageX: y + v,
                  pageY: p + m,
            ...
            c(p(p(I)), 'keyDrop', function(e) {
              I.handleSortEnd(e),
                I.initialFocusedNode && I.initialFocusedNode.focus();
            }),
            c(p(p(I)), 'handleKeyEnd', function(e) {
              I.manager.active && I.keyDrop(e);
            }),
            c(p(p(I)), 'isValidSortingTarget', function(e) {
              var t = I.props.useDragHandle,
                n = e.target,
                o = W(n, function(e) {
                  return null != e.sortableInfo;
                });
